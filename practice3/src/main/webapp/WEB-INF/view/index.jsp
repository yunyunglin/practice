...
<body>
    ...
    <div>
        ...
        <ul>
            <li>
                <a href='${pageContext.request.contextPath}/emp/listAllEmp'>List</a> all Emps.
            </li>
            <br>

            <li>
                <form method="POST" action="${pageContext.request.contextPath}/emp/listOneEmp" >
                    <b>輸入員工編號 (如7001):</b>
                    <input type="text" name="empno">
                    <input type="submit" value="送出">
                    <input type="hidden" name="requestURL" value="select_page">
                </form>
            </li>
    ...
    <div>
        <h3>員工管理</h3>
        <ul>
            <li><a href='${pageContext.request.contextPath}/emp/addEmp'>Add</a> a new Emp.</li>
        </ul>
    </div>
    <div>
